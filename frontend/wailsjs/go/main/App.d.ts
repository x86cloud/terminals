...
export function AgentAnswerAsk(arg1:string,arg2:string):Promise<boolean>;

export function AgentApprovePlan(arg1:string):Promise<boolean>;

export function AgentCancelPlan(arg1:string):Promise<boolean>;

export function AgentClearHistory():Promise<void>;

export function AgentConfirmTool(arg1:string,arg2:boolean):Promise<boolean>;

export function AgentCreateSession(arg1:string):Promise<store.SessionItem>;

export function AgentDecideApproval(arg1:string,arg2:boolean,arg3:boolean,arg4:string):Promise<boolean>;

export function AgentDeleteSession(arg1:string):Promise<boolean>;

export function AgentGetAuditLogs(arg1:string,arg2:number):Promise<Array<store.AuditLogItem>>;

export function AgentGetHistory():Promise<Array<agent.FrontendMessage>>;

export function AgentGetJob(arg1:string):Promise<store.JobItem>;

export function AgentGetJobOutput(arg1:string,arg2:number):Promise<Array<store.JobOutputItem>>;

export function AgentGetPendingApprovals():Promise<Array<guard.ApprovalRequest>>;

export function AgentGetPendingAsks():Promise<Array<ask.AskRequest>>;

export function AgentGetSessionMessages(arg1:string):Promise<Array<agent.FrontendMessage>>;

export function AgentGetSkillsDir():Promise<string>;

export function AgentGetWorkspaceDir():Promise<string>;

export function AgentInterruptSubagent(arg1:string):Promise<boolean>;

export function AgentKillJob(arg1:string):Promise<boolean>;

export function AgentListJobs(arg1:string):Promise<Array<store.JobItem>>;

export function AgentListSessions():Promise<Array<store.SessionItem>>;

export function AgentListSkills():Promise<Array<skills.Skill>>;

export function AgentListSubagents(arg1:string):Promise<Array<store.SubagentItem>>;

export function AgentOpenSkillsDir():Promise<string>;

export function AgentProposePlan(arg1:string,arg2:string):Promise<planner.Plan>;

export function AgentRecallMemories(arg1:string,arg2:number):Promise<Array<string>>;

export function AgentRetryPlanStep(arg1:string,arg2:string):Promise<planner.PlanStep>;

export function AgentSaveHistory(arg1:Array<agent.FrontendMessage>):Promise<void>;

export function AgentSaveMemory(arg1:string,arg2:string,arg3:string,arg4:string):Promise<void>;

export function AgentSaveSessionMessages(arg1:string,arg2:Array<agent.FrontendMessage>):Promise<void>;

export function AgentSelectWorkspaceDir():Promise<string>;

export function AgentSend(arg1:string,arg2:Array<agent.FrontendMessage>):Promise<string>;

export function AgentSendSubagent(arg1:string,arg2:string):Promise<string>;
