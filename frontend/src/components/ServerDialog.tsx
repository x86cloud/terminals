                    ...
                    <>
                        ...
                        {showAdv && (
                            <>
                                ...
                                <div className="field-row">
                                    <label className="switch-field inline">
                                        <span>清除会话</span>
                                        <span className="switch">
                                ...
                                <div className="field">
                                    <span className="group-title">遗嘱消息 (Last Will)</span>
                                </div>
                                <label className="field">
                                ...
                                <label className="field">
                                    <textarea className="grow" rows={2}
